...
export default function Home() {
  return (
    <main className="min-h-svh md:min-h-screen flex justify-center items-center">
      <div>
        <div className="max-w-[360px] bg-zinc-800 text-center flex flex-col gap-6 rounded-lg backdrop-blur-lg p-8">
          ...
          <div>
            ...
            <h2 className="text-sm font-inter">Make a new doc to bring your words, data and ideas together.</h2>
          </div>
